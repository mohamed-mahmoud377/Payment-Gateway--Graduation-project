...
import {PaymentRequestListener} from "./events/listeners/paymentRequestListener";
...
const start = async ()=>{
    ...
    try{
        ...
        new PaymentRequestListener(natsWrapper.client).listen();
    ...
    app.listen(3000,()=>{
        console.log('payment srv is up and running on port 3000  ')
    })
}
